...
class Car {
     ...
     */
    accelerate(value) {
        this.speed = this.speed + value < this.maxSpeed ? this.speed += value : this.speed;
    }
...
Car.getSpecs(mustang);
// maxSpeed: 200, speed: 0(30), isOn: false, distance: 130, price: 2000

console.log(`Mustang price: ${mustang.price}`); // 2000
mustang.price = 4000;
console.log(`Mustang price: ${mustang.price}`); // 4000